...
function Footer() {
   return (
      <footer className="border-t border-2 border-[#D1BAEF] pt-10 pb-5">
         <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 text-[#1A1A1A]">
            ...
            <div>
               ...
               <ul className="flex flex-col gap-3 text-[16px] font-[400]">
                  <a href="https://www.instagram.com/vionixacademy?igsh=MTE1am42ZmF0a2RoaA==" className="flex items-center gap-2">
                     <img src={insta} alt="social-media" /> Instagram
                  </a>
                  <a href="https://www.linkedin.com/company/vionixacademy/" className="flex items-center gap-2">
                     <img src={linkedin} alt="social-media" /> Linkedin
                  </a>
                  <a href="https://www.tiktok.com/@vionixacademy?_t=ZS-8zCId2BNpic&_r=1" className="flex items-center gap-2">
            ...
            <div>
               ...
               <ul className="flex flex-col gap-3 text-[16px] font-[400]">
                  <li>
                     <a href="https://vionix.az" target="_blank" rel="noreferrer">
                        www.vionix.az
                     </a>
                  </li>
                  <li>
         ...
         <div className="container mx-auto mt-12 border-t border-[#E5D7F8] pt-6 text-center text-sm text-[#3A3A3A]">© 2025 Vionix Academy. Bütün hüquqlar qorunur.</div>
      </footer>
   );
}
